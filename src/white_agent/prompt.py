...
class PromptTemplate:
    ...
    SYSTEM_PROMPT = """You are an expert software engineer specializing in algorithm
    ...
    def _build_system_message(self, problem: Dict[str, Any]) -> str:
        ...
        if difficulty == "Easy":
            guidance = (
                ...
                "Simple, readable solutions are preferred."
            )
        elif difficulty == "Hard":
            guidance = (
                "\nThis is a challenging problem. "
                "Consider advanced data structures and algorithms."
            )
        else:
